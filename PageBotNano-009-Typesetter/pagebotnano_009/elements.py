...
from pagebotnano_009.constants import CENTER
from pagebotnano_009.babelstring import BabelString
...
class TextBox(Text):
    ...
    >>> from pagebotnano_009.document import Document
    >>> from pagebotnano_009.babelstring import BabelString
    >>> from pagebotnano_009.toolbox.loremipsum import loremipsum
    >>> headLine = 'Example of TextBox overflow\\n'
    >>> txt = loremipsum()
    >>> fontSize = 30
    >>> headSize = fontSize*1.5
    >>> headStyle = dict(font='Georgia-Bold', lineHeight=headSize*1.2, fontSize=headSize, fill=0)
    >>> textStyle = dict(font='Georgia', lineHeight=fontSize*1.4, fontSize=fontSize, fill=0)
