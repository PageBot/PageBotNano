...
class Element:
    ...
    def compose(self, doc, page, parent=None):
        ...
        >>> from pagebotnano_010.document import Document
        >>> from pagebotnano_010.templates.onecolumn import oneColumnPage
        >>> doc = Document()
        >>> page = oneColumnPage(doc)
        """
...
class TextBox(Text):
    ...
    >>> textStyle = dict(font='Georgia', lineHeight=fontSize*1.4, fontSize=fontSize, fillcolor(0))
