...
def indexPage(doc, theme=None, page=None, **kwargs):
    page = _initalize(doc, page)
    return page
...
def frenchPage(doc, theme=None, page=None, **kwargs):
...
def titlePage(doc, theme=None, page=None, **kwargs):
