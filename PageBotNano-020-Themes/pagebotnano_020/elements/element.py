...
from pagebotnano_020.toolbox import makePadding, path2FileName
...
class Element:
    ...
    def compose(self, doc, page, parent=None):
        ...
        >>> from pagebotnano_020.themes import SeasoningTheDish
...
class TextBox(Text):
    ...
    >>> from pagebotnano_020.document import Document
    >>> from pagebotnano_020.babelstring import BabelString
    >>> from pagebotnano_020.toolbox.loremipsum import loremipsum
