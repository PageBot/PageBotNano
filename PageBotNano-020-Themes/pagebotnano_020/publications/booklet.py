...
from pagebotnano_020.constants import CENTER, LEFT, RIGHT, EN, MAIN
from pagebotnano_020.publications.publication import Publication
from pagebotnano_020.document import Document
from pagebotnano_020.elements import Rect, Text, TextBox, Image
from pagebotnano_020.babelstring import BabelString
from pagebotnano_020.toolbox.typesetter import Typesetter
from pagebotnano_020.templates.onecolumn import (coverPage, oneColumnPage, 
...
class Booklet(Publication):
    ...
    >>> from pagebotnano_020.constants import A5
    >>> from pagebotnano_020.toolbox.loremipsum import loremipsum, randomName, randomTitle
    >>> from pagebotnano_020.templates.onecolumn import *
