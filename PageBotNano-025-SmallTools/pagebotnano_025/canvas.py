...
class Canvas(Group):
    ...
    def __init__(self, posSize, delegate=None, canvasSize=(800, 600),
        ...
        #self.clipView.setPostsBoundsChangedNotifications_(True)
        #from AppKit import NSNotificationCenter, NSViewBoundsDidChangeNotification
        #import objc
        #s = objc.selector('scrolled', ':')
        #NSNotificationCenter.defaultCenter().addObserver_selector_name_object_(self,
        #        'boundDidChange:', NSViewBoundsDidChangeNotification,
        #        self.clipView)

        # TODO: het width and height from view.
        w, h = canvasSize
        self.width = w
        self.height = h
