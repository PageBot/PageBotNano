...
from pagebotnano_030.fonttoolbox.analyzers.apointcontextlist import Vertical, Horizontal
from pagebotnano_030.fonttoolbox.analyzers.stems import Stem, Bar, Counter, VerticalCounter
...
class GlyphAnalyzer:
    ...
    def onBlack(self, p):
        ...
        # FIXME: needs a cyclic import of context.
        # TODO: do this outside class, i.e. in the context itself.
        #context = getContext()
        #glyphPath = context.getGlyphPath(self.glyph)
        #return context.onBlack(p, glyphPath)
        # FIXME: this is going to give bad results.
        return False
