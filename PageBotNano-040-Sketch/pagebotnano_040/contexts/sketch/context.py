...
from pagebotnano.contexts.sketchbuilder import SketchBuilder
...
class SketchContext:
    ...
    def __init__(self, path=None):
        ...
        if path is None:
            # In case no path was defined, take the default template from resources.
            path = '../../resources/Template.sketch'
