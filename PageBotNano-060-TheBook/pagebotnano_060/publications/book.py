...
from pagebotnano_060.constants import CENTER, LEFT, RIGHT, EN
from pagebotnano_060.publications.publication import Publication
from pagebotnano_060.document import Document
from pagebotnano_060.elements import Rect, Text, TextBox, Image, Marker
...
class Book(Publication):
    ...
    def compose(self, page=None, targets=None):
        ...
        >>> book = Book(w=w, h=h, templates=OneColumnTemplates, styles=styles, galley=g)
        >>> book.galley.elements[0]
        <Marker type=page index=None>
