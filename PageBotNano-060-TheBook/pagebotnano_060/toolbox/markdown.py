...
def parseMarkdownFile(path):
    ...
    True
    >>> '<footnote ref="1">' in xml and '</footnote>' in xml
    True
    """
...
def parseMarkdown(txt):
    ...
    >>> xml = '## H2\\n$footnote12$ Footnote text\\n'
    >>> parseMarkdown(xml)
    '<xml><h2>H2</h2>\\n<footnote ref="12"> Footnote text</footnote>\\n</xml>'
    >>> xml = '## H2\\n$literature123$ Literature text\\n'
    >>> parseMarkdown(xml)
    '<xml><h2>H2</h2>\\n<literature ref="123"> Literature text</literature>\\n</xml>'
    ...
    # $footnote12$ --> <footnote ref="12">...</footnote> # XML-based content tags
    # $literature123$ --> <literature ref="123">...</literature123> # XML-based content tags
    txt = re.sub('\\$([a-zA-Z]*)([0-9][0-9]*)\\$([^#].*)$', '<\\1 ref="\\2">\\3</\\1>', txt, flags=re.MULTILINE)
    # $author$ --> <author>...</author> # XML-based content tags
