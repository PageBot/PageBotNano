...
class PublishinVariablesTheme(IntoTheWoods):

    logo1 = color(1)
    logo2 = color(1, 0, 0) # Red
    logo3 = color(0xEC842C)

theme = PublishinVariablesTheme()

siteData = sd = SiteData(id='publishingvariables', title='Publishing Variables', theme=theme)
sd.menuName = 'Menu'
sd.year = now().year
sd.copyright = ' | '.join((
...
intro1 = """## Scripting the many repeating details of a design project – like publishing this magazine – gives designers a chance to test the options without going through a lot of manual work."""
section1 = """### What happens if designers learn to code?
...
image1 = """[h=800](../resources/images/Berthold-Grid.pdf)"""

caption1 = """**<bi>The Droste Effect</bi> (Dutch origin), known in art as “mise en abyme,” is the effect of a picture recursively appearing within itself. Recursion is an important tool in parametric design processes.**"""
caption2 = """<bi>TYPETR Upgrade website</bi>
...
caption3 = """**PageBot scripts not only generated the website, but all illustrations, diagrams and animations as well. The design part is figuring out how to write the code that matches the sketch.**"""
caption4 = """<bi>The PageBot Library</bi>
**PageBot is an MIT Open Source Python library for automated creations of publications. It can read and write many file formats, such as databases, images, animations and fonts. This allows for accurate parametric design, depending on platform and context, as type in print behaves very differently from type displayed on screen. The structure of typographic content for dynamic media—like websites—needs to be different from column layouts for fixed paper sizes.**
