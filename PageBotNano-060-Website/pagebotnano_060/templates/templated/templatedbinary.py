...
#
#   The TemplatedBinary class supports the following anchors
#
...
class TemplatedBinary(TemplatedBase):
    """    
    The TemplatedBinary reads all templates sources, ending with .css,
    ...
    True
    """
    TEMPLATE_NAME = 'templated-binary' # This class is optimised for this set of templates.
