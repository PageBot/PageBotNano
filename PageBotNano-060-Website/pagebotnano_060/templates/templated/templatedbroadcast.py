...
#
#   The TemplatedBroadcast class supports the following anchors
#
...
class TemplatedBroadcast(TemplatedBase):
    """    
    The TemplatedBroadcast reads all templates sources, ending with .css,
    ...
    >>> wt = TemplatedBroadcast()
    >>> len(wt.htmlTemplates) > 0
    True
    """
    TEMPLATE_NAME = 'templated-broadcast' # This class is optimised for this set of templates.
