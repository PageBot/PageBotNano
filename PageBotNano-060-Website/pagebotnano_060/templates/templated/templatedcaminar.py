...
#
#   The TemplatedCaminar class supports the following anchors
#
...
class TemplatedCaminar(TemplatedBase):
    """    
    The TemplatedCaminar reads all templates sources, ending with .css,
    ...
    True
    """
    TEMPLATE_NAME = 'templated-caminar' # This class is optimised for this set of templates.
