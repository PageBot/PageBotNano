...
#
#   The TemplatedEpilogue class supports the following anchors
#
...
class TemplatedEpilogue(TemplatedBase):
    """    
    The TemplatedEpilogue reads all templates sources, ending with .css,
    ...
    >>> wt = TemplatedEpilogue()
    >>> len(wt.htmlTemplates) > 0
    True
    """
    TEMPLATE_NAME = 'templated-epilogue' # This class is optimised for this set of templates.
