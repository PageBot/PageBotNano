...
#
#   The TemplatedFullmotion class supports the following anchors
#
...
class TemplatedFullmotion(TemplatedBase):
    """    
    The TemplatedFullmotion reads all templates sources, ending with .css,
    ...
    >>> wt = TemplatedFullmotion()
    >>> len(wt.htmlTemplates) > 0
    True
    """
    TEMPLATE_NAME = 'templated-fullmotion' # This class is optimised for this set of templates.
