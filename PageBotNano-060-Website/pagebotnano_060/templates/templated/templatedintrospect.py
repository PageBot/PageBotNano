...
#
#   The TemplatedIntrospect class supports the following anchors
#
...
class TemplatedIntrospect(TemplatedBase):
    """    
    The TemplatedIntrospect reads all templates sources, ending with .css,
