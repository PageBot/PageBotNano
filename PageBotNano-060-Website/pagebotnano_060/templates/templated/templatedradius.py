...
#
#   The TemplatedRadius class supports the following anchors
#
...
class TemplatedRadius(TemplatedBase):
    """    
    The TemplatedRadius reads all templates sources, ending with .css,
    ...
    True
    """
    TEMPLATE_NAME = 'templated-radius' # This class is optimised for this set of templates.
