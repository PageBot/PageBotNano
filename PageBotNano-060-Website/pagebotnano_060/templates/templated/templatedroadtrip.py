...
#
#   The TemplatedRoadTrip class supports the following anchors
#
...
class TemplatedRoadtrip(TemplatedBase):
    """    
    The TemplatedRoadtrip reads all templates sources, ending with .css,
    ...
    True
    """
    TEMPLATE_NAME = 'templated-roadtrip' # This class is optimised for this set of templates.
