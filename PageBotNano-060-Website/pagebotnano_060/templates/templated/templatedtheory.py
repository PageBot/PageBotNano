...
#
#   The TemplatedTheory class supports the following anchors
#
...
class TemplatedTheory(TemplatedBase):
    """    
    The TemplatedTheory reads all templates sources, ending with .css,
    ...
    True
    """
    TEMPLATE_NAME = 'templated-theory' # This class is optimised for this set of templates.
    ...
    def _menuLinks(self, siteData, pageData, index):
        ...
        <nav id="nav">
            ...
            <a href="article.html">Generic</a>
            <a href="elements.html">Elements</a>
        </nav>
        """
        html = """\n<nav id="nav">"""
        for pageData in siteData.pages:
            html += """\n\t<a href="%s.html">%s</a>""" % (pageData.id, pageData.title)
        html += """\n</nav>"""
        return html
